...
const Services = () => {
  ...
  useEffect(() => {
    // Simulate an asynchronous loading process with setTimeout
  ...
  // Use another useEffect to trigger animations after loading
  useEffect(() => {
    // Trigger animation for the header when isLoading becomes false
    if (!isLoading) {
      ...
      // Trigger animation for the cards when isLoading becomes false
      cardControls.start({
        y: 0,
        opacity: 1,
        transition: {
  ...
  }, [isLoading, headerControls, cardControls])
          ...
          <div className="my-20">
            <ul className="flex gap-10">
              ...
              >
                ...
                <h2 className="text-3xl font-bold text-clr3">
                  Web Development
                </h2>
